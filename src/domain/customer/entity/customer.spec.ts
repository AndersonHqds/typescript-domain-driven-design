...
jest.mock('../events/customer/handlers/envia-console-log-1.handler');
jest.mock('../events/customer/handlers/envia-console-log-2.handler');
jest.mock("../events/customer/handlers/envia-console-log.handler")
